...
namespace ShoppingWebservice.Data {
    ...
    public class ShoppingDbInitializer : DropCreateDatabaseAlways<ShoppingContext> {
        ...
        protected override void Seed(ShoppingContext context) {
            ...
            User kurt = new User("kurt", "kurt", "Kurt",  "Hansen", "kurt@gmail.com", "Imaginative Street 123, 4000 Fantasy World");
            ...
            //tobias cart 1
            Cart kurtCart = new Cart(kurt);
            kurtCart.CartItems.Add(new CartItem(hvedemel, hvedemel.Price, 4));
            kurtCart.CartItems.Add(new CartItem(jerseyLetmælk, jerseyLetmælk.Price, 6));
            kurtCart.CartItems.Add(new CartItem(nøddemix, nøddemix.Price, 2));
            kurtCart.CartItems.Add(new CartItem(millionbøf, millionbøf.Price, 1));
            kurtCart.CartItems.Add(new CartItem(vitaminC, vitaminC.Price, 1));
            carts.Add(kurtCart);
